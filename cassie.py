...
class Cassie(pygame.sprite.Sprite):
    ...
    def __init__(self, image="images/cassie/cassie-front-0.png", x=100, y=100):
        ...
        self.imagelist_left = [pygame.image.load(imagefile).convert() for imagefile in  sorted(glob.glob('images/cassie/cassie-left-*.png'))]
        for i in self.imagelist_left:
             i.set_colorkey((1,0,0))
        self.imagelist_right = [pygame.image.load(imagefile).convert() for imagefile in  sorted(glob.glob('images/cassie/cassie-right-*.png'))]
