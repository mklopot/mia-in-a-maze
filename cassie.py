...
class Cassie(pygame.sprite.Sprite):

    def __init__(self, image="images/cassie/cassie-front-0.png", x=100, y=100):
        ...
        self.main_shape = pymunk.Poly.create_box(self.body, size=(16,47), offset=(0,-1))
        self.main_shape.layers = self.main_shape.layers ^ 0b1000
        self.feet_shape = pymunk.Poly(self.body, [(5,23),(-5,23),(-5,23),(5,23)],offset=(0,2))
        ...
        self.imagelist_left = [pygame.image.load(imagefile).convert_alpha() for imagefile in  sorted(glob.glob('images/cassie/cassie-left-*.png'))]
        self.imagelist_right = [pygame.image.load(imagefile).convert_alpha() for imagefile in  sorted(glob.glob('images/cassie/cassie-right-*.png'))]
        self.left_counter = 0
    ...
    def update(self):
        ...
        if self.body.position.x > 4000 or self.body.position.x < -1000:
